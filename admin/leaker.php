          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Agents Details </h3><span class="float-right"><a href="#" class="btn btn-primary"><i class="fa fa-cry">Search to Find Guilty Agent</i></a></span>
              </div>
               <!-- /.card-header -->
              <?php
              $act =1;
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover text-bold">
