...
if(isset($_GET['dis_id'])){
    $id=$_GET['dis_id'];
    $sqldis="select * from distributor where distributor_id='$id'";
              ...
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="manage.php">
                      <input type="hidden" name="dis_id" value="<?php echo $row['distributor_id'] ; ?>">
                    ...
                    <div class="form-group row">
                      <div class="offset-4 col-8">
                        <button name="d_update" type="submit" id="submit" class="btn btn-primary">Update User</button>
                      </div>
                    </div>
                  </form>
                </div>
