...
<div class="alert alert-warning">
  <?php echo $_SESSION['req'] ?>
            ...
            <div class="card-header">
              <h2 class=" text-bold">Report Generation</h2>
            </div>
              <!-- /.card-header -->
            <?php
                  ...
                  <?php while($row = mysqli_fetch_array($qry)):?>
                    <tr>
                      ...
                      <form action="manage.php" method="POST">
                          <input type="hidden" name="dell" value="<?php echo $row['file_id']; ?>">
                          <button type="submit" name="file_admin_del" class="btn btn-danger btn-flat">Delete</button>
                        </form>
                      </td>
