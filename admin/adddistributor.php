      ...
      <div class="row">
        <div class="col-md-3 ">
          <div class="list-group ">
            ...
            <a href="#"  class="list-group-item list-group-item-action active">Add Distributor</a>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <p class="float-right">
                      <?php if(isset($_SESSION['distributor_s'])){?>
                         <p class="text-success float-right"><?php echo $_SESSION['distributor_s'];?> <i class="fa fa-check"></i></p> 
                         <?php unset($_SESSION['distributor_s']);
                      }
                          ...
                          elseif(isset($_SESSION['distributor_exist'])){?>
                            <p class="text-danger float-right"><?php echo $_SESSION['distributor_exist'];?> <i class="fa fa-ban"></i></p> 
                            <?php
                             unset($_SESSION['distributor_exist']);
                          }
                        ?>
                  ...
                  <form method="POST" action="manage.php" class="form-group">
                    ...
                    <div class="form-group row">
                      <div class="offset-4 col-8">
                        <button name="distributor" type="submit" id="distributor" class="btn btn-primary">Submit <i class="fa fa-comment-dollar"></i> <i class="fa fa-arrow-right"></i></button>
                      </div>
                    </div>
                  </form>
                </div>
