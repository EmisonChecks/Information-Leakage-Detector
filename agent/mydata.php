        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-title">Agent's Data</h3>
            </div>
              <!-- /.card-header -->
            <?php
            $me = $_SESSION['agent'];
                ...
                <tbody>
                  <?php while($row = mysqli_fetch_array($qry)):?>
                    <tr>
                      ...
                      <!--<td><img src="<?php /*echo isset($row['path']) ? '../files/'.$row['path'] :''*/ ?>" alt=""></td>-->
                      <!--Checks in future if u want agents to download their files remove the fucking comment sysmple below -->
                      <!--<td><a href="<?php echo isset($row['path']) ? '../files/'.$row['path'] :'' ?>" target="_blank" download="<?php $row['file_name'] ?>" class="text-bold">Download File</a></td>-->
                      <td><a href="manage.php?file_id=<?php echo $row['file_id']; ?>" class="btn btn-danger rounded">Delete</a></td>
                    </tr>
                    <tr>
                      <?php $i++; endwhile; ?>
                    </tfoot>
