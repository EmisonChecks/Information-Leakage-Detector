                ...
                <div class="col-md-12">
                  <form method="POST" action="manage.php">
                    ...
                    <div class="form-group row">
                      <label for="name" class="col-4 col-form-label">Department</label> 
                      <div class="col-8">
                        <input id="name" name="dept" placeholder="Department" class="form-control here"  type="text" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="username" class="col-4 col-form-label">Description *</label> 
                      <div class="col-8">
                        <textarea rows="5" id="username" name="description" placeholder="description" class="form-control here"  type="text"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="lastname" class="col-4 col-form-label">Distributor *</label> 
                      <div class="col-8">
                          <?php
                    ...
                    <div class="form-group row">
                      <div class="offset-4 col-8">
                        <button name="request" type="submit" id="submit" class="btn btn-primary">Submit</button>
                      </div>
                    </div>
                  </form>
                </div>
