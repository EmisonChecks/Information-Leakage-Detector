        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-left clearfix">
              ...
              <li class="nav-item">
                <a class="nav-link" href="addagent.php" color="white">
                  Add Agent
                </a>
              </li>
            </ul>
                ...
                <tbody>
                  <?php while($row = mysqli_fetch_array($qry)):?>
                    <tr>
                      ...
                      <td><a href="editagent.php?agent_id=<?php echo $row['agent_id'];?>" class="btn btn-primary rounded">Edit</a></td>
                      <td><a href="manage.php?agent_id=<?php echo $row['agent_id'];?>" class="btn btn-danger rounded">Delete</a></td>
                    </tr>
                    <tr>
                      <?php $i++; endwhile; ?>
                    </tfoot>
