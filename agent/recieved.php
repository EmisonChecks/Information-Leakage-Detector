...
<div class="alert alert-warning">
  <?php echo $_SESSION['req'] ?>
            ...
            <?php
            $me = $_SESSION['agent'];
            $sql = "select * from share where agent='$me' order by share_id desc";
                ...
                <tbody>
                  <?php while($row = mysqli_fetch_array($qry)):?>
                    <tr>
                      ...
                      <td> 
                          <a href="<?php echo isset($row['path']) ? '../files/'.$row['path'] :'' ?>" download="<?php $row['file_name'] ?>" class="text-bold">Download File</a>
                      <td>
                    </tr>
                    <tr>
                      <?php  $i++; endwhile; # ?>
