                ...
                <tbody>
                  <?php while($row = mysqli_fetch_array($qry)):?>
                    <tr>
                      ...
                      <td><?php echo $row['file_name']; ?><br><a href="<?php echo isset($row['path']) ? '../files/'.$row['path'] :'' ?>" target="_blank">View Data</a></td>
                      <!--<td><img src="<?php /*echo isset($row['path']) ? '../files/'.$row['path'] :''*/ ?>" alt=""></td>-->
                      <td><?php echo $row['user']; ?></td>
                      <td><?php echo $row['secret_key']; ?></td>
                      <td>
                      <form action="share.php" method="POST">
                          <input type="hidden" name="user" value="<?php echo $_SESSION['distributor']; ?>">
                          ...
                          <button type="submit" name="share" class="btn btn-outline-primary btn-flat">Share File</button>
                        </form>
                      </td>
